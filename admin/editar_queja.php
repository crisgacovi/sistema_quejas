...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <!-- Botón Volver en la parte superior - MODIFICADO -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <!-- Agregamos ID al formulario para poder referenciarlo en JavaScript -->
                        <form action="editar_queja.php?id=<?php echo $id; ?>" method="post" id="form-editar-queja">
                            <div class="row">
                                <!-- Datos del paciente -->
                                <div class="col-md-6">
                ...
                <!-- Modal de confirmación para cancelar/volver - NUEVO -->
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="#" id="confirm-redirect" class="btn btn-primary">Sí, salir</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Script para manejar los botones - NUEVO -->
    <script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function mostrarConfirmacion(destino) {
            if (formModificado) {
                const modal = new bootstrap.Modal(document.getElementById('confirmModal'));
                confirmRedirect.href = destino;
                modal.show();
                return false;
            } else {
        ...
        btnCancelar.addEventListener('click', function(e) {
            e.preventDefault();
            mostrarConfirmacion('ver_queja.php?id=<?php echo $id; ?>');
        });
        ...
        // Mejora visual para el botón guardar

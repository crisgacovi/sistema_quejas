...
$stats = [
    'total' => $conn->query("SELECT COUNT(*) as count FROM quejas")->fetch_assoc()['count'],
    'pending' => $conn->query("SELECT COUNT(*) as count FROM quejas WHERE estado = 'pendiente'")->fetch_assoc()['count'],
    'in_progress' => $conn->query("SELECT COUNT(*) as count FROM quejas WHERE estado = 'en_proceso'")->fetch_assoc()['count'],
    'resolved' => $conn->query("SELECT COUNT(*) as count FROM quejas WHERE estado = 'resuelto'")->fetch_assoc()['count'],
    'closed' => $conn->query("SELECT COUNT(*) as count FROM quejas WHERE estado = 'cerrado'")->fetch_assoc()['count']
];
...
<body>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($queja['archivo_adjunto']): ?>
                                                ...
                                                ?>
                                                <a href="../<?php echo $queja['archivo_adjunto']; ?>" 
    ...
    <script>
        // Inicializar todos los componentes de Bootstrap

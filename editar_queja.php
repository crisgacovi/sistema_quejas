...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        if (strtolower($estado) !== strtolower($queja['estado'])) {
        ...
        header("Location: ver_queja.php?id=" . $id . "&success=1");
        exit;
...
<body>
                    ...
                    <div class="card-body">
                        <form action="editar_queja.php?id=<?php echo $id; ?>" method="post" id="form-editar-queja" class="needs-validation" novalidate>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <div class="btn-group">
                                    <a href="ver_queja.php?id=<?php echo $id; ?>" class="btn btn-secondary" id="btn-volver">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="confirmModalLabel">¿Desea salir sin guardar?</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <p>Hay cambios sin guardar. ¿Está seguro de que desea salir?</p>
                                <p class="text-danger"><small>Todos los cambios se perderán.</small></p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
                                    <i class="bi bi-x"></i> Cancelar
                                </button>
                                <a href="#" class="btn btn-primary" id="confirm-redirect">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Capturar el estado inicial del formulario
        const formInitialState = new FormData(form);
        ...
        function hasFormChanged() {
            ...
            for (let pair of currentFormData.entries()) {
                if (formInitialState.get(pair[0]) !== pair[1]) {
                    return true;
                }
            }
            return false;
        ...
        function handleNavigation(destination, event) {
            ...
            if (hasFormChanged()) {
                confirmRedirect.setAttribute('href', destination);
                modal.show();
            } else {
        ...
        if (btnVolver) {
            btnVolver.addEventListener('click', function(e) {
                handleNavigation(this.getAttribute('href'), e);
            });
        }
